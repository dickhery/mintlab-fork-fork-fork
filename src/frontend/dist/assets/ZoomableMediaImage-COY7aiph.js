...
function collectionTrustDescription(status) {
  switch (status) {
    case "Verified":
...
export {
  ...
  collectionTrustDescription as b,
  collectionMetaMap as c,
  collectionTrustBadgeClass as d,
  collectionTrustLabel as e,
