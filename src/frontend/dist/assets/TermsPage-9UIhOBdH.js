import { aj as useTermsAcceptance, j as jsxRuntimeExports, q as Link, B as Button, ak as TERMS_LAST_UPDATED, al as TERMS_EFFECTIVE_DATE, am as TERMS_VERSION, ai as TriangleAlert, an as termsRiskHighlights, a1 as CircleDollarSign, ao as FileText, ap as termsSections, m as motion } from "./index-BiU-kY3M.js";
...
function TermsPage() {
  ...
  const acceptButtonLabel = !isAuthenticated ? "Sign In to Accept" : accepted ? "Terms Accepted" : isAccepting ? "Accepting..." : "Accept Terms";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            disabled: isAuthLoading || isAuthenticated && !isBackendReady || isAccepting || isChecking || isAuthenticated && accepted,
            onClick: () => {
              void acceptTerms();
            },
        ...
        error ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-2xl rounded-md border border-destructive/30 bg-destructive/10 px-3 py-2 text-sm leading-relaxed text-destructive", children: error }) : null
      ] })
    ] }) }),
