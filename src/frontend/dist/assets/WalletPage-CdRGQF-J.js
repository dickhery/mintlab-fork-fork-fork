import { c as createLucideIcon, j as jsxRuntimeExports, m as motion, a as cn, u as useAuth, b as useBackend, d as useAdmin, e as useQueryClient, r as reactExports, f as useQuery, g as ue, W as Wallet, B as Button, L as LogIn, T as TermsAgreementNotice, P as Principal } from "./index-BF3zA9NM.js";
import { P as Plus, i as isLowCyclesError, A as AppCanisterTopUpDialog } from "./AppCanisterTopUpDialog-VBJAXZdY.js";
import { n as nftCustodyLabel, a as nftCustodyClass, C as CollectionBadge, P as PriceDisplay, W as WITHDRAW_TO_EXTERNAL_WALLET_LABEL, t as transferRegisteredNFT, b as nftCustodyDescription } from "./external-nft-transfer-BJyvWXpd.js";
import { F as Flag, D as DividendBalanceBadge, c as collectionMetaMap, a as collectionTrustStatus, i as isMintlabVerifiedCollection, C as COMMUNITY_COLLECTION_NOTICE, P as PaymentConfirmationDialog, Z as ZoomableMediaImage, T as Tag } from "./ZoomableMediaImage-WTGa6U10.js";
import { M as MediaImage, E as EmptyState, C as Coins } from "./MediaImage-yXoEWK4H.js";
import { H as HelpCallout, a as HelpTooltip } from "./HelpCallout-BsO_-6O6.js";
import { B as Badge } from "./badge-CkH3vkoX.js";
import { I as ImageOff, r as resolveImageUrl } from "./media-BuWOn7fn.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-CA2UTBV6.js";
import { u as useMutation, R as RefreshCw, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, L as Label } from "./index-D7cqR8Lf.js";
import { I as Input } from "./input-D8Sgqhfs.js";
import { L as Layers, C as Check, I as Info, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, T as Textarea, E as ExternalLink } from "./textarea-4Bzxw1gl.js";
import { S as Skeleton, C as Copy } from "./skeleton-Dbx23qhb.js";
import { u as useInfiniteQuery, S as Sparkles, c as compressModerationImage } from "./imageUtils-vuN5nti1.js";
import { A as ArrowUpRight, H as History, S as Send, a as ArrowDownLeft } from "./send-1vEpyVRc.js";
import { C as CircleCheck } from "./circle-check-D4tVdeAi.js";
import "./icp-BXjZNIYq.js";
import "./arrow-right-BRlQtAfJ.js";
import "./index-Ds0-1EMq.js";
/**
...
function getNFTDisplayTokenId(nft) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3 bg-muted/30 rounded-xl border border-border", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono mt-0.5", children: getNFTTokenLabel(nft) }),
              collection && /* @__PURE__ */ jsxRuntimeExports.jsx(
                CollectionBadge,
                {
                  collection,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex max-h-[calc(100dvh-2rem)] min-h-0 flex-col md:grid md:grid-cols-[minmax(0,0.9fr)_minmax(320px,1fr)]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-0 overflow-y-auto p-5 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { className: "space-y-2 text-left", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-mono", children: getNFTTokenLabel(nft) })
          ] }),
            ...
            syncStatus.kind === "partial" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.span,
              {
                ...
                children: [
                  ...
                  syncStatus.skipped.length > 0 ? onlyAutoIndexing ? `${indexingSkips.length} indexing` : `${setupSkips.length} need setup` : syncStatus.newCount > 0 ? `${syncStatus.newCount} synced; some warnings` : "Some collections need attention"
                ]
              }
            ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-4", children: [
          ...
          syncStatus.kind === "partial" && (syncStatus.skipped.length > 0 || progress) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-amber-200/70 bg-amber-50/70 p-3 dark:border-amber-900/50 dark:bg-amber-950/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: progress ? "Selected collection sync progress" : onlyAutoIndexing ? "Automatic discovery is indexing" : "Some collections need discovery setup" }),
            ...
            syncStatus.skipped.slice(0, 4).map((skip) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "shrink-0", children: isAutoIndexingSkip(skip) ? "Indexing" : "Needs setup" })
                ]
              },
            ...
            syncStatus.skipped.length > 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              ...
              " more collections",
              " ",
              onlyAutoIndexing ? "are indexing automatically." : "need discovery setup."
            ] })
          ] }) }),
          ...
          if (!silent) {
            ...
            if (newCount > 0) {
              ue.success(
                ...
                {
                  description: syncSkipped.length > 0 ? onlyAutoIndexing ? `${indexingSkipped.length} collection(s) are still indexing automatically.` : `${setupSkipped.length} collection(s) need extra discovery setup.` : "Some collections could not be checked."
                }
              );
              ...
              ue(
                ...
                {
                  description: onlyAutoIndexing ? "Automatic discovery is catching up in small batches. Click Sync again shortly, or import a known token ID directly." : `${setupSkipped.length} collection(s) need extra discovery setup before automatic discovery can find new NFTs.`
                }
              );
            } else {
