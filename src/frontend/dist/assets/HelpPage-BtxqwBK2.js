import { c as createLucideIcon, r as reactExports, ag as useRouterState, j as jsxRuntimeExports, q as Link, B as Button, W as Wallet, a1 as CircleDollarSign, H as History, ah as CreditCard, S as ShoppingBag, a2 as Grid3x3, Z as CircleHelp, m as motion, ai as TriangleAlert } from "./index-BiU-kY3M.js";
...
import { A as ArrowRight } from "./arrow-right-Ci5MH1wk.js";
...
const helpSections = [
  ...
  },
  {
    ...
    summary: "The Activity page shows your latest Mintlab events in one feed, including ICP transfers, NFT mints, marketplace trades, dividend claims, and collection operations.",
    keywords: [
      "activity",
      "history",
      "transactions",
...
const faqItems = [
  ...
  },
  {
    ...
    answer: "When moderation is enabled, Mintlab checks uploaded images and metadata for moderation and copyright issues before ICP is transferred. If an upload is blocked, the paid action should not continue."
  },
  {
    question: "Can AI moderation hide my collection?",
    answer: "Yes. Mintlab follows AI moderation and copyright decisions for in-app visibility, so NFTs or collections that fail those checks may be hidden from public view. Avoid potentially copyrighted images, characters, logos, watermarks, and protected artwork unless you have permission."
  },
  {
...
const glossaryItems = [
  ...
  {
    term: "AI Moderation",
    definition: "Automated review used by Mintlab to check uploaded or imported content. Mintlab follows AI moderation and copyright decisions for in-app visibility."
  },
  {
    term: "Principal ID",
    definition: "Your Internet Computer identity. Send NFTs to this ID unless the selected collection shows a different NFT receive destination."
  },
  {
    term: "Vaulted NFT",
    definition: "An external NFT held by the Mintlab vault. A sale changes Mintlab's in-app owner record first; the buyer can withdraw the original NFT to an external wallet later."
  }
];
const sectionIcons = {
  overview: BookOpen,
