import { c as createLucideIcon, j as jsxRuntimeExports, m as motion, a as cn, u as useAuth, b as useBackend, d as useAdmin, e as useQueryClient, r as reactExports, f as useQuery, g as ue, W as Wallet, B as Button, L as LogIn, T as TermsAgreementNotice, P as Principal } from "./index-CusP570m.js";
import { P as Plus, i as isLowCyclesError, A as AppCanisterTopUpDialog } from "./AppCanisterTopUpDialog-f_tZsWXm.js";
import { n as nftCustodyLabel, a as nftCustodyClass, C as CollectionBadge, P as PriceDisplay, W as WITHDRAW_TO_EXTERNAL_WALLET_LABEL, t as transferRegisteredNFT, b as nftCustodyDescription } from "./external-nft-transfer-B8OF87bR.js";
import { D as DividendBalanceBadge, c as collectionMetaMap, a as collectionTrustStatus, i as isMintlabVerifiedCollection, C as COMMUNITY_COLLECTION_NOTICE, P as PaymentConfirmationDialog, Z as ZoomableMediaImage, F as Flag, T as Tag } from "./ZoomableMediaImage-C3RsqdA5.js";
import { g as getNFTDisplayName, M as MediaImage, E as EmptyState, C as Coins, a as getNFTTokenLabel, b as getNFTDisplayTokenId, c as getNFTVisibleAttributes } from "./nft-display-DleW5UFq.js";
import { H as HelpCallout, a as HelpTooltip } from "./HelpCallout-NtXJI52G.js";
import { B as Badge } from "./badge-DeSGmGMF.js";
import { I as ImageOff, r as resolveImageUrl } from "./media-DvD7_vwl.js";
import { S as Skeleton, C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./skeleton-BglC0KEL.js";
import { u as useMutation, R as RefreshCw, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, L as Label } from "./index-DVAdOJEx.js";
import { I as Input } from "./input-Bzx2MD2W.js";
import { L as Layers, C as Check, I as Info, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, T as Textarea, E as ExternalLink } from "./textarea-B5sJ7iJ8.js";
import { u as useInfiniteQuery, S as Sparkles, c as compressModerationImage } from "./imageUtils-ysR9Lfpe.js";
import { A as ArrowUpRight, H as History, S as Send, a as ArrowDownLeft } from "./send-BbeAqLJq.js";
import { C as CircleCheck } from "./circle-check-BOxlj2jD.js";
import { C as Copy } from "./copy-B8YKKVp5.js";
import "./icp-BXjZNIYq.js";
import "./arrow-right-BXi7oTyR.js";
...
const SYNC_PARTIAL_STATUS_CLEAR_MS = 45e3;
...
function selectedSyncProgressMessage(progress, collection) {
  var _a, _b;
  const checkedDirectHint = progress.scannedThisRun === 0n && progress.indexedThisRun === 0n && progress.nextCursor === null;
...
function RecentNFTTransactionRow({ tx }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 py-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[11px] text-muted-foreground", children: formatTransactionTime(tx.occurredAt) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Badge,
      {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: [0, 1, 2, 3].map((row) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: row > 1 ? "hidden md:block" : "", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 py-3", children: [
          ...
          "div",
          {
            ...
            children: transactions.map((tx, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: index === 0 ? "" : index === 1 ? "border-t border-border/50 md:border-t-0" : "border-t border-border/50",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 px-5 py-3 border-b border-border bg-accent/5 sm:flex-row sm:items-center sm:justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-end gap-2", children: [
            ...
            syncStatus.kind === "partial" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.span,
              {
                ...
                children: [
                  ...
                  syncStatus.skipped.length > 0 ? onlyAutoIndexing ? `${indexingSkips.length} indexing` : `${setupSkips.length} need action` : syncStatus.newCount > 0 ? `${syncStatus.newCount} synced; some warnings` : "Some collections need attention"
                ]
              }
            ),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    SelectTrigger,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "mr-1.5 h-3 w-3 shrink-0 text-muted-foreground" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All collections" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            ...
            selectedSyncCollection && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                value: syncTokenHint,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  ...
                  isSyncing ? "Syncing…" : selectedSyncCollection ? "Sync selected" : "Sync"
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            ...
            accountIdHex ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wider", children: "Account ID — use for ICP and EXT NFTs" }),
          ...
          syncStatus.kind === "partial" && (syncStatus.skipped.length > 0 || progress) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-amber-200/70 bg-amber-50/70 p-3 dark:border-amber-900/50 dark:bg-amber-950/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: progress ? "Selected collection sync progress" : onlyAutoIndexing ? "Automatic discovery is indexing" : "Some collections need targeted sync" }),
                ...
                ) : onlyAutoIndexing ? "Sync is indexing imported collections in safe pages. New NFTs appear as soon as they are found; known token IDs can still be imported directly." : "All-collection sync skips broad discovery scans to stay responsive. Select a collection and run Sync selected, or enter a known token ID to verify it directly." })
              ] })
            ] }),
            syncStatus.skipped.slice(0, 4).map((skip) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  !isAutoIndexingSkip(skip) && onIndexCollection ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      size: "sm",
                      variant: "outline",
                  ...
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "shrink-0", children: isAutoIndexingSkip(skip) ? "Indexing" : "Action needed" })
                ]
              },
            ...
            syncStatus.skipped.length > 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              ...
              " more collections",
              " ",
              onlyAutoIndexing ? "are indexing automatically." : "need targeted sync."
            ] })
          ] }) }),
  ...
  reactExports.useEffect(() => {
    if (syncStatus.kind === "ok" || syncStatus.kind === "upToDate" || syncStatus.kind === "partial" || syncStatus.kind === "error") {
      const id = setTimeout(
        ...
        syncStatus.kind === "partial" ? SYNC_PARTIAL_STATUS_CLEAR_MS : SYNC_FINISHED_STATUS_CLEAR_MS
      );
          ...
          if (typeof actor.syncUserNFTsForCollectionV2 === "function") {
            ...
            if (!progressResult.ok.complete && skipped3.length === 0) {
              skipped3.push({
                ...
                collectionName,
                reason: "INDEXING_IN_PROGRESS",
                message: "Mintlab saved selected sync progress for this collection. Click Sync selected again to continue, or enter a known token ID."
              });
            }
            return {
              __kind__: "ok",
          ...
          if (!silent) {
            ...
            if (newCount > 0) {
              ue.success(
                ...
                {
                  description: syncSkipped.length > 0 ? onlyAutoIndexing ? `${indexingSkipped.length} collection(s) are still indexing automatically.` : `${setupSkipped.length} collection(s) need targeted sync or a token ID.` : "Some collections could not be checked."
                }
              );
              ...
              ue(
                ...
                {
                  description: onlyAutoIndexing ? "Automatic discovery is catching up in small batches. Click Sync again shortly, or import a known token ID directly." : `${setupSkipped.length} collection(s) need targeted sync or a token ID before automatic discovery can find new NFTs.`
                }
              );
            } else {
