import { c as createLucideIcon, j as jsxRuntimeExports, m as motion, a as cn, u as useAuth, b as useBackend, d as useAdmin, e as useQueryClient, r as reactExports, f as useQuery, g as ue, W as Wallet, B as Button, L as LogIn, T as TermsAgreementNotice, P as Principal } from "./index-uVpqRcsX.js";
import { P as Plus, i as isLowCyclesError, A as AppCanisterTopUpDialog } from "./AppCanisterTopUpDialog-CN_Pu1LJ.js";
import { n as nftCustodyLabel, a as nftCustodyClass, C as CollectionBadge, P as PriceDisplay, W as WITHDRAW_TO_EXTERNAL_WALLET_LABEL, t as transferRegisteredNFT, b as nftCustodyDescription } from "./external-nft-transfer-DPbjv6Pt.js";
import { F as Flag, D as DividendBalanceBadge, c as collectionMetaMap, a as collectionTrustStatus, i as isMintlabVerifiedCollection, C as COMMUNITY_COLLECTION_NOTICE, P as PaymentConfirmationDialog, Z as ZoomableMediaImage, T as Tag } from "./ZoomableMediaImage--t4oWugy.js";
import { M as MediaImage, E as EmptyState, C as Coins } from "./MediaImage-BFZrHaTd.js";
import { H as HelpCallout, a as HelpTooltip } from "./HelpCallout-uf1opgXj.js";
import { B as Badge } from "./badge-BycFIhqh.js";
import { I as ImageOff, r as resolveImageUrl } from "./media-DehOaY_s.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-DI3a4V8E.js";
import { u as useMutation, R as RefreshCw, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, L as Label } from "./index-ClEHAcQY.js";
import { I as Input } from "./input-IwVe5FO0.js";
import { L as Layers, C as Check, I as Info, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, T as Textarea, E as ExternalLink } from "./textarea-DaUO6cS_.js";
import { S as Skeleton, C as Copy } from "./skeleton-BmgS1aXd.js";
import { u as useInfiniteQuery, S as Sparkles, c as compressModerationImage } from "./imageUtils-DJjpU_qk.js";
import { C as CircleCheck } from "./circle-check-EUzMdI65.js";
import { S as Send } from "./send-rUyrU2j_.js";
import "./icp-BXjZNIYq.js";
import "./arrow-right-BQvvfCWP.js";
import "./index-Mxw-FGj7.js";
/**
...
function selectedSyncProgressMessage(progress, collection) {
  ...
  const scope = totalSupply != null ? `${scannedTotal.toString()} of ${totalSupply.toString()} tokens` : `${scannedTotal.toString()} token positions`;
