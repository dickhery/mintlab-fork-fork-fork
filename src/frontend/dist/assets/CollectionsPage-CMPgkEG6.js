import { r as reactExports, n as useComposedRefs, j as jsxRuntimeExports, i as Primitive, q as Presence, l as createContextScope, k as composeEventHandlers, p as useCallbackRef, I as useLayoutEffect2, a as cn, b as useBackend, u as useAuth, d as useAdmin, e as useQueryClient, f as useQuery, J as AnimatePresence, m as motion, B as Button, g as ue, K as CircleDollarSign, X, M as Grid3x3, P as Principal, T as TermsAgreementNotice, t as LoadingSpinner } from "./index-uVpqRcsX.js";
import { A as AppCanisterTopUpDialog, i as isLowCyclesError, L as LoaderCircle, P as Plus } from "./AppCanisterTopUpDialog-CN_Pu1LJ.js";
import { r as recommendedCollectionCreationTopUpCycles, S as Switch, C as CollectionCreationDiagnosticsPanel, T as Trash2 } from "./switch-DphrwJaz.js";
import { c as collectionMetaMap, a as collectionTrustStatus, i as isMintlabVerifiedCollection, C as COMMUNITY_COLLECTION_NOTICE, T as Tag, P as PaymentConfirmationDialog, F as Flag, e as collectionTrustLabel, b as collectionTrustDescription, d as collectionTrustBadgeClass, D as DividendBalanceBadge, Z as ZoomableMediaImage } from "./ZoomableMediaImage--t4oWugy.js";
import { E as EmptyState, M as MediaImage } from "./MediaImage-BFZrHaTd.js";
...
import { u as useMutation, R as RefreshCw, L as Label, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, e as DialogFooter } from "./index-ClEHAcQY.js";
import { I as Input } from "./input-IwVe5FO0.js";
import { u as useDirection } from "./index-Mxw-FGj7.js";
import { f as clamp, L as Layers, E as ExternalLink, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, T as Textarea, C as Check, I as Info } from "./textarea-DaUO6cS_.js";
import { S as Skeleton, C as Copy } from "./skeleton-BmgS1aXd.js";
import { S as Sparkles, u as useInfiniteQuery, c as compressModerationImage } from "./imageUtils-DJjpU_qk.js";
import { r as resolveImageUrl, I as ImageOff } from "./media-DehOaY_s.js";
import { A as ArrowLeft } from "./arrow-left-BJs9TDo1.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PaymentConfirmationDialog,
      {
        ...
        description: (moderationConfig == null ? void 0 : moderationConfig.enabled) ? "Mintlab checks the uploaded image before any ICP is transferred." : "Confirm the ICP payment from your in-app account before Mintlab creates your collection canister.",
        lines: [
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-0.5 flex items-center gap-2 flex-wrap", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    ...
                    children: collectionTrustLabel(trustStatus)
                  }
                )
              ] })
            ] }),
...
function NFTBrowser({
  ...
  const tokenLookupMutation = useMutation({
    ...
    onSuccess: (nft) => {
      ...
      setSelectedNFT(nft);
      ue.success(`Loaded NFT #${nft.tokenId}`);
    },
    onError: (err) => {
      ue.error(extractError(err));
    }
