import { r as reactExports, j as jsxRuntimeExports, h as useComposedRefs, a as cn, k as useNavigate, C as CircleHelp, B as Button } from "./index-CovTg-hX.js";
import { d as useId, g as useControllableState, R as Root2, A as Anchor, P as Primitive, e as composeEventHandlers, i as Presence, o as Portal$1, w as Arrow, p as createPopperScope, t as DismissableLayer, C as Content, J as Root, f as createContextScope, H as createSlottable } from "./index-CkhE-A-E.js";
import { A as ArrowRight } from "./arrow-right-0kqjpRcW.js";
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 items-start gap-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleHelp, { className: "mt-0.5 h-4 w-4 shrink-0 text-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm leading-relaxed text-muted-foreground", children })
          ] })
        ] }),
        sectionId && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            type: "button",
            variant: "ghost",
            ...
            "data-ocid": ocid ? `${ocid}.link` : void 0,
            children: [
              actionLabel,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        "aria-label": label,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleHelp, { className: "h-3.5 w-3.5" })
      }
    ) }),
