import { c as createLucideIcon, r as reactExports, u as useControllableState, j as jsxRuntimeExports, P as Primitive, q as useId, d as composeEventHandlers, e as Presence, f as createContextScope, a as cn, h as useBackend, g as useAuth, k as useQueryClient, o as useNavigate, n as ue, l as useQuery, B as Button, s as LoadingSpinner, X, S as ShoppingBag, A as AlertDialog, t as AlertDialogContent, v as AlertDialogHeader, w as AlertDialogTitle, x as AlertDialogDescription, T as TermsAgreementNotice, y as AlertDialogFooter, z as AlertDialogCancel, C as AlertDialogAction, m as motion } from "./index-Dj-Yle62.js";
import { R as Root, I as Item, c as createRovingFocusGroupScope, W as WITHDRAW_TO_EXTERNAL_WALLET_LABEL, n as nftCustodyLabel, a as nftCustodyClass, i as isVaultedInMintlab, V as VAULTED_PURCHASE_NOTICE, C as CollectionBadge, P as PriceDisplay, b as nftCustodyDescription, t as transferRegisteredNFT } from "./external-nft-transfer-CNJY9u3G.js";
import { c as collectionMetaMap, a as collectionTrustStatus, T as Tag, C as COMMUNITY_COLLECTION_NOTICE, i as isMintlabVerifiedCollection, D as DividendBalanceBadge, Z as ZoomableMediaImage, F as Flag, P as PaymentConfirmationDialog } from "./ZoomableMediaImage-Be_NDl0T.js";
import { E as EmptyState, a as getNFTTokenLabel, g as getNFTDisplayName, M as MediaImage, C as Coins } from "./nft-display-DMXXrUTg.js";
import { H as HelpCallout, a as HelpTooltip } from "./HelpCallout-FYwOHYyZ.js";
import { B as Badge } from "./badge-BJ5Wfo5U.js";
import { a as useMutation, R as RefreshCw, D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, L as Label } from "./index-40ZerjYh.js";
...
import { I as ImageOff } from "./media-DY_p1Fev.js";
...
function MarketplacePage() {
  ...
  const allListings = listingDetails.map((detail) => {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    TabsTrigger,
                    {
                      ...
                      children: [
                        ...
                        "All Listings",
                        allListings.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "ml-2 bg-background/20 text-current text-[10px] px-1.5 py-0 font-mono border-0", children: allListings.length })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
