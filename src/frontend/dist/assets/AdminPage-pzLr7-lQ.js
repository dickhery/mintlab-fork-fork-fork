import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as cn, p as useNavigate, k as useAdmin, i as useBackend, l as useQueryClient, n as useQuery, V as Shield, o as ue, B as Button, t as Principal, F as AlertDialog, Y as AlertDialogTrigger, G as AlertDialogContent, I as AlertDialogHeader, J as AlertDialogTitle, K as AlertDialogDescription, M as AlertDialogFooter, N as AlertDialogCancel, O as AlertDialogAction, U as Actor } from "./index-BiU-kY3M.js";
import { L as LoaderCircle, A as AppCanisterTopUpDialog, P as Plus, F as Fuel } from "./AppCanisterTopUpDialog-D1gcHMDT.js";
import { S as Switch, r as recommendedCollectionCreationTopUpCycles, T as Trash2, C as CollectionCreationDiagnosticsPanel } from "./switch-CFvQnvi6.js";
import { B as Badge } from "./badge-D_-CjnkQ.js";
import { S as Skeleton, C as Card, a as CardHeader, b as CardTitle, d as CardDescription, c as CardContent } from "./skeleton-CwTRWGRY.js";
import { I as Input } from "./input-ChNEJpc7.js";
import { P as Primitive, u as useMutation, L as Label } from "./label-CNkKwLQi.js";
import { b as ChevronDown, S as Select, c as SelectTrigger, d as SelectValue, e as SelectContent, f as SelectItem, C as Check } from "./select-CT7-_nRB.js";
import { T as Textarea, I as Info } from "./textarea-IlutF4N-.js";
import { r as resolveImageUrl, I as ImageOff } from "./media-Bp5Di5gC.js";
import { L as Layers } from "./layers-B27LRsMc.js";
import { S as Search } from "./search-BG7FIrIG.js";
import { R as RefreshCw } from "./index-RRgS0f5h.js";
import { C as CircleAlert } from "./circle-alert-Dy0a5afS.js";
import { E as ExternalLink } from "./external-link-96Qbqw79.js";
import { S as ShieldCheck } from "./shield-check-BHrk29Aj.js";
import { C as Copy } from "./copy-BzbKx2mK.js";
import "./dialog-BFuSAU7k.js";
/**
...
function nftReportStatusLabel(status) {
  switch (status) {
    case "AutoHidden":
      return "Auto-hidden";
    case "Approved":
...
function nftReportStatusVariant(status) {
...
function MarketplaceEscrowRepairPanel() {
  ...
  const resolvePendingBidMutation = useMutation({
    ...
    onSuccess: () => {
      ue.success("Pending bid resolution started.");
    },
    onError: (err) => {
      ue.error(extractError(err));
    }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-end gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              resolvePendingBidMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 15, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 15 }),
              "Resolve Pending Bid"
            ]
          }
        ),
...
function CollectionRow({
  ...
  const resolvedTrustStatus = (importMeta == null ? void 0 : importMeta.trustStatus) ?? (collection.kind === "Minted" ? "Verified" : "CommunityImported");
  ...
  const resetIndexMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      void queryClient.invalidateQueries({ queryKey: ["collections"] });
      ue.success("Ownership index reset for this collection.");
    },
    onError: (err) => {
      ue.error(`Failed to reset ownership index: ${extractError(err)}`);
    }
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  ...
                  className: "text-xs shrink-0",
                  children: collectionTrustLabel(resolvedTrustStatus)
                }
              )
            ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-2 border-t border-border pt-2 sm:grid-cols-[1fr_1fr_auto]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              inputMode: "numeric",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 border-t border-border pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] leading-relaxed text-muted-foreground", children: "Verify marks the collection as Mintlab reviewed. Needs Range flags missing token browse data. Disable Sync stops wallet auto-sync. Hide removes it from public browsing. Block removes public access and prevents sync or marketplace use." }),
...
function CollectionCreationRequestsPanel() {
  ...
  const { data: requestResult, isLoading } = useQuery({
    ...
    refetchInterval: (query) => {
      ...
      const requests2 = (result == null ? void 0 : result.__kind__) === "ok" ? result.ok : [];
      return requests2.some(isRepairableCollectionCreationRequest) ? 6e4 : false;
    }
  });
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-muted/20 p-4 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              ...
              " and optional xAI",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: XAI_COPYRIGHT_MODEL }),
              " ",
              "copyright review before any ICP transfer."
            ] })
          ] }),
          moderationConfigLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-end gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                children: (moderationConfig == null ? void 0 : moderationConfig.apiKeyConfigured) ? "OpenAI key set" : "No OpenAI key"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                variant: (moderationConfig == null ? void 0 : moderationConfig.xaiApiKeyConfigured) ? "secondary" : "outline",
                children: (moderationConfig == null ? void 0 : moderationConfig.xaiApiKeyConfigured) ? "xAI key set" : "No xAI key"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "moderation-xai-api-key", children: "xAI API key" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                placeholder: (moderationConfig == null ? void 0 : moderationConfig.xaiApiKeyConfigured) ? "Leave blank to keep current key" : "xai-...",
        ...
        (moderationConfig == null ? void 0 : moderationConfig.xaiApiKeyConfigured) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4 rounded-lg border border-border bg-background/60 p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "moderation-clear-xai-key", children: "Clear stored xAI key on save" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Switch,
            {
...
function NFTReportsPanel({ collections }) {
  const { actor, isFetching } = useBackend();
  const queryClient = useQueryClient();
  ...
  const collectionById = reactExports.useMemo(() => {
  ...
  const reviewMutation = useMutation({
    mutationFn: async ({
      ...
      if (!actor) throw new Error("Backend not ready");
      const result = action === "approve" ? await actor.adminApproveNFTReport(
        report.collectionId,
        report.tokenId
    ...
    onSuccess: () => {
      ...
      ue.success("NFT report reviewed.");
    },
    onError: (err) => {
      ue.error(`Failed to review NFT report: ${extractError(err)}`);
    }
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-primary/20 bg-card", "data-ocid": "admin.nft_reports", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "User NFT reports and automatic 4-report hiding review queue." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: reports.length })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 rounded-lg" }, item)) }) : sortedReports.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-dashed border-border bg-muted/20 px-3 py-8 text-center text-sm text-muted-foreground", children: "No NFT reports yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: sortedReports.map((report) => {
      const collection = collectionById.get(
        report.collectionId.toString()
      );
      const reviewed = report.status === "Approved" || report.status === "Hidden";
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "rounded-lg border border-border bg-muted/20 px-3 py-2.5",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground", children: (collection == null ? void 0 : collection.name) ?? `Collection ${report.collectionId.toString()}` }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: nftReportStatusVariant(report.status), children: nftReportStatusLabel(report.status) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", children: [
                  report.reportCount.toString(),
                  " report",
              ...
              report.lastReportReason && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: report.lastReportReason }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground", children: [
                "Last flagged ",
                formatReportTime(report.lastReportedAt),
                report.reviewedAt ? ` · Reviewed ${formatReportTime(report.reviewedAt)}` : ""
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex shrink-0 flex-wrap gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  variant: "secondary",
                  className: "gap-2",
                  onClick: () => reviewMutation.mutate({ report, action: "approve" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  variant: "outline",
                  className: "gap-2",
                  onClick: () => reviewMutation.mutate({ report, action: "hide" }),
                  disabled: reviewMutation.isPending || report.status === "Hidden",
        ...
        `${report.collectionId.toString()}:${report.tokenId}`
      );
    }) }) })
  ] });
}
function AdminPage() {
  ...
  const { actor, isFetching } = useBackend();
  const queryClient = useQueryClient();
  const [collectionSearch, setCollectionSearch] = reactExports.useState("");
  ...
  const filteredCollections = reactExports.useMemo(() => {
    ...
    return allCollections.filter((collection) => {
      ...
      const status = (meta == null ? void 0 : meta.trustStatus) ?? (collection.kind === "Minted" ? "Verified" : "CommunityImported");
      return [
        collection.name,
        collection.symbol,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(NFTReportsPanel, { collections: collections ?? [] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              !isLoading && collectionSearch.trim() && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
                "Showing ",
                filteredCount,
                " of ",
                count
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative sm:w-80", children: [
          ...
          ) : filteredCount === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 32, className: "text-muted-foreground/40 mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-muted-foreground", children: "No collections match that search" })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "admin.collections.list", children: filteredCollections.map((col, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            CollectionRow,
            {
              collection: col,
