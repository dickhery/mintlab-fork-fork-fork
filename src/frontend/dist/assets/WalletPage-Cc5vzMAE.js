import { c as createLucideIcon, j as jsxRuntimeExports, m as motion, a as cn, u as useAuth, b as useBackend, d as useAdmin, e as useQueryClient, r as reactExports, f as useQuery, g as ue, W as Wallet, B as Button, L as LogIn, T as TermsAgreementNotice, P as Principal } from "./index-BRQzfS48.js";
import { P as Plus, i as isLowCyclesError, A as AppCanisterTopUpDialog } from "./AppCanisterTopUpDialog-7nGNo5D6.js";
import { n as nftCustodyLabel, a as nftCustodyClass, C as CollectionBadge, P as PriceDisplay, W as WITHDRAW_TO_EXTERNAL_WALLET_LABEL, t as transferRegisteredNFT, b as nftCustodyDescription } from "./external-nft-transfer-CUQRBTFu.js";
import { D as DividendBalanceBadge, c as collectionMetaMap, a as collectionTrustStatus, i as isMintlabVerifiedCollection, C as COMMUNITY_COLLECTION_NOTICE, P as PaymentConfirmationDialog, Z as ZoomableMediaImage, F as Flag, T as Tag } from "./ZoomableMediaImage-DAWJ9axu.js";
import { g as getNFTDisplayName, M as MediaImage, E as EmptyState, C as Coins, a as getNFTTokenLabel, b as getNFTDisplayTokenId, c as getNFTVisibleAttributes } from "./nft-display-RiwTJD0W.js";
import { H as HelpCallout, a as HelpTooltip } from "./HelpCallout-CEdy3SaW.js";
import { B as Badge } from "./badge-CAQTzjT8.js";
import { I as ImageOff, r as resolveImageUrl } from "./media-C3Z_66Ob.js";
import { S as Skeleton, C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./skeleton-DTNcXC1h.js";
import { u as useMutation, R as RefreshCw, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, L as Label } from "./index-Cj-qz8fT.js";
import { I as Input } from "./input-CL8teu4y.js";
import { L as Layers, C as Check, I as Info, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, T as Textarea, E as ExternalLink } from "./textarea-BRcMLthH.js";
import { u as useInfiniteQuery, S as Sparkles, c as compressModerationImage } from "./imageUtils-BQwOAm6j.js";
import { A as ArrowUpRight, H as History, S as Send, a as ArrowDownLeft } from "./send-Di3qW-eO.js";
import { C as CircleCheck } from "./circle-check-tqWmM1Vu.js";
...
function RecentNFTTransactionsCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "min-w-0 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex min-w-0 items-center justify-between text-sm font-medium text-muted-foreground uppercase tracking-wider", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "min-w-0 overflow-hidden", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
function WalletPage() {
  ...
  const openImportSpecificNFT = reactExports.useCallback((collectionId) => {
