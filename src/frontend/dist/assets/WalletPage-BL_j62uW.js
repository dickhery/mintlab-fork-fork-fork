import { c as createLucideIcon, j as jsxRuntimeExports, m as motion, a as cn, u as useAuth, b as useBackend, d as useAdmin, e as useQueryClient, r as reactExports, f as useQuery, g as ue, W as Wallet, B as Button, L as LogIn, T as TermsAgreementNotice, P as Principal } from "./index-DlRXlsBg.js";
import { P as Plus, i as isLowCyclesError, A as AppCanisterTopUpDialog } from "./AppCanisterTopUpDialog-Bty_WxmW.js";
import { n as nftCustodyLabel, a as nftCustodyClass, C as CollectionBadge, P as PriceDisplay, W as WITHDRAW_TO_EXTERNAL_WALLET_LABEL, t as transferRegisteredNFT, b as nftCustodyDescription } from "./external-nft-transfer-DDnMLfxG.js";
import { D as DividendBalanceBadge, c as collectionMetaMap, a as collectionTrustStatus, i as isMintlabVerifiedCollection, C as COMMUNITY_COLLECTION_NOTICE, P as PaymentConfirmationDialog, Z as ZoomableMediaImage, F as Flag, T as Tag } from "./ZoomableMediaImage-BkIBoK61.js";
import { g as getNFTDisplayName, M as MediaImage, E as EmptyState, C as Coins, a as getNFTTokenLabel, b as getNFTDisplayTokenId, c as getNFTVisibleAttributes } from "./nft-display-DLz0Fm2C.js";
import { H as HelpCallout, a as HelpTooltip } from "./HelpCallout-DpYSEoT8.js";
import { B as Badge } from "./badge-DzLhewEv.js";
import { I as ImageOff, r as resolveImageUrl } from "./media-CSMDHZ-y.js";
import { S as Skeleton, C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./skeleton-bbLsEODd.js";
import { u as useMutation, R as RefreshCw, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, L as Label } from "./index-DiE_m_up.js";
import { I as Input } from "./input-DSdG7PIB.js";
import { L as Layers, C as Check, I as Info, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, T as Textarea, E as ExternalLink } from "./textarea-D9m3MpVE.js";
import { u as useInfiniteQuery, S as Sparkles, c as compressModerationImage } from "./imageUtils-RgjMfJbi.js";
import { A as ArrowUpRight, H as History, S as Send, a as ArrowDownLeft } from "./send-C_NyM2xS.js";
import { C as CircleCheck } from "./circle-check--hxHw3jF.js";
import { C as Copy } from "./copy-CwbzZ-Pl.js";
import "./icp-BXjZNIYq.js";
import "./arrow-right-BHxA9Q3E.js";
