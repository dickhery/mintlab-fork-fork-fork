import { r as reactExports, b as useComposedRefs, j as jsxRuntimeExports, P as Primitive, e as Presence, f as createContextScope, d as composeEventHandlers, R as useCallbackRef, $ as useLayoutEffect2, a as cn, i as useBackend, h as useAuth, k as useAdmin, l as useQueryClient, n as useQuery, a0 as AnimatePresence, m as motion, B as Button, o as ue, s as getNFTTokenLabel, g as getNFTDisplayName, a1 as CircleDollarSign, X, a2 as Grid3x3, t as Principal, T as TermsAgreementNotice, w as getNFTVisibleAttributes, v as getNFTDisplayTokenId, q as Link, E as LoadingSpinner } from "./index-BiU-kY3M.js";
import { A as AppCanisterTopUpDialog, i as isLowCyclesError, L as LoaderCircle, P as Plus } from "./AppCanisterTopUpDialog-D1gcHMDT.js";
import { r as recommendedCollectionCreationTopUpCycles, S as Switch, C as CollectionCreationDiagnosticsPanel, T as Trash2 } from "./switch-CFvQnvi6.js";
import { T as Tag, P as PaymentConfirmationDialog, F as Flag, D as DividendBalanceBadge } from "./PaymentConfirmationDialog-B90HwVe5.js";
import { E as EmptyState } from "./EmptyState-Tf-mkftn.js";
import { H as HelpCallout, a as HelpTooltip } from "./HelpCallout-DPK1x29J.js";
import { M as MediaImage } from "./MediaImage-C4cSkM5Y.js";
import { c as copyTextToClipboard, S as ShareLinkButton, n as nftShareUrl } from "./share-urls-DKbJaUql.js";
import { c as collectionMetaMap, a as collectionTrustStatus, i as isMintlabVerifiedCollection, C as COMMUNITY_COLLECTION_NOTICE, b as collectionTrustLabel, d as collectionTrustDescription, e as collectionTrustBadgeClass, Z as ZoomableMediaImage } from "./ZoomableMediaImage-BwntiiZF.js";
...
import { S as Sparkles, u as useInfiniteQuery, C as Collapsible, a as CollapsibleTrigger, b as CollapsibleContent, c as compressModerationImage } from "./imageUtils-DSdPjpW5.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, e as DialogFooter } from "./dialog-BFuSAU7k.js";
import { I as Input } from "./input-ChNEJpc7.js";
import { u as useMutation, L as Label } from "./label-CNkKwLQi.js";
import { u as useDirection, h as clamp, S as Select, c as SelectTrigger, d as SelectValue, e as SelectContent, f as SelectItem, b as ChevronDown, C as Check } from "./select-CT7-_nRB.js";
...
import { A as ArrowLeft } from "./arrow-left-fYbG_BeN.js";
...
import "./coins-LQqBQMSN.js";
import "./arrow-right-Ci5MH1wk.js";
...
const MAX_DIVIDEND_SOURCE_DESCRIPTION_CHARS = 2e3;
function formatBasisPointsPercent(basisPoints) {
...
function formatDividendShareSummary(nftCount, nftShareBasisPoints) {
  if (nftCount <= 0n) {
...
function CopyField({ label, value, ocid }) {
  ...
  async function handleCopy() {
    if (!await copyTextToClipboard(value)) {
      ue.error(`Could not copy ${label.toLowerCase()}`);
      return;
    }
    setCopied(true);
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2 text-base", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4 shrink-0 text-accent" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: "Import an ICP NFT Collection" })
                ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleContent, { id: "collections-import-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        ...
                        onChange: (event) => {
                          var _a;
                          return void handleImportImageFile(
                            ((_a = event.target.files) == null ? void 0 : _a[0]) ?? null
                          );
                        },
      ...
      Collapsible,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2 text-base", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 shrink-0 text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: "Create Your Mintlab Collection" })
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleContent, { id: "collections-create-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
...
function CollectionControllersDialog({
  ...
  async function copyPrincipal(value) {
    if (await copyTextToClipboard(value)) {
      ue.success("Controller principal copied");
    } else {
      ue.error("Could not copy controller principal");
    }
  }
...
function NFTBrowser({
  ...
  const canisterUrl = `https://dashboard.internetcomputer.org/canister/${canisterId}`;
  const dividendsEnabled = ((_a = collection.dividendConfig) == null ? void 0 : _a.enabled) === true;
  const [editingDividendSource, setEditingDividendSource] = reactExports.useState(false);
  const [dividendSourceDraft, setDividendSourceDraft] = reactExports.useState("");
  const {
    data: browsePages,
    isLoading,
    isFetchingNextPage,
  ...
  const updateDividendSourceMutation = useMutation({
    mutationFn: async (sourceDescription) => {
      if (!actor) throw new Error("Backend not connected");
    ...
    onSuccess: () => {
      ...
      ue.success("Dividend source details updated");
      void queryClient.invalidateQueries({
        queryKey: ["collectionDividendInfo", collection.id.toString()]
      });
    },
          ...
          Button,
          {
            ...
            onClick: async () => {
              if (await copyTextToClipboard(canisterId)) {
                ...
                ue.error("Could not copy collection canister");
              }
            },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Send ICP to this address, then check for deposits. New deposits are split evenly across every minted NFT in this collection." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground mt-2", children: formatDividendShareSummary(
                dividendInfo.nftCount,
                dividendInfo.nftShareBasisPoints
              ) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
              canManageCollection && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
                  variant: "outline",
                  ...
                  children: dividendInfo.sourceDescription ? "Edit source" : "Add source"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border/50 bg-card/60 px-3 py-3 space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-wide text-muted-foreground", children: "Expected dividend source" }),
            dividendInfo.sourceDescription ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground whitespace-pre-wrap", children: dividendInfo.sourceDescription }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground italic", children: canManageCollection ? "Describe where this collection expects ICP dividend deposits to come from." : "The collection creator has not described the expected dividend source yet." })
          ] }),
            ...
            Dialog,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                DialogContent,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Expected dividend source" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Tell holders where ICP sent to this collection's dividend address is expected to come from." })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "dividend-source-description", children: "Source details" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Textarea,
                        {
                          id: "dividend-source-description",
                          value: dividendSourceDraft,
                          onChange: (event) => setDividendSourceDraft(event.target.value),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          onClick: () => updateDividendSourceMutation.mutate(
                            dividendSourceDraft.trim() === "" ? null : dividendSourceDraft.trim()
                          ),
                          disabled: updateDividendSourceMutation.isPending,
                          "data-ocid": "collections.dividends.source_save_button",
                          children: updateDividendSourceMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : "Save"
                        }
                      )
                    ] })
                  ]
...
function CollectionsPage() {
  ...
  const [importCollectionOpen, setImportCollectionOpen] = reactExports.useState(false);
  const [createCollectionOpen, setCreateCollectionOpen] = reactExports.useState(false);
  ...
  const { data: pendingCreationRequests = [] } = useQuery({
    ...
    refetchInterval: (query) => {
      ...
      return requests.some(isRepairableCollectionCreationRequest) ? 12e4 : false;
    }
  });
          ...
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              NFTBrowser,
              {
                ...
                canManageCollection: myCreatedCollectionIds.has(selectedCollection.id.toString()) || isAdmin && selectedCollection.kind === "Minted",
