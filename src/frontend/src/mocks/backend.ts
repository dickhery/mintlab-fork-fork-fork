...
export const mockBackend: backendInterface = {
  ...
  disburseCollectionDividends: async (collectionId) => ({
    __kind__: "ok" as const,
    ok: {
      collectionId,
      synced: {
      ...
      skippedCount: 0n,
      remainingCount: 0n,
      totalPaidE8s: 100_000_000n,
      totalFeeE8s: 20_000n,
      feeTopUpE8s: 20_000n,
      feeTopUpBlockIndex: 88n,
      feeReserveRemainingE8s: 0n,
      failures: [],
    },
  }),
  ...
  previewCollectionDividendDisbursement: async (collectionId) => ({
    __kind__: "ok" as const,
    ok: {
      collectionId,
      accountId: mockAccountId,
      ...
      distributableBalanceE8s: 99_980_000n,
      processedBalanceE8s: 100_000_000n,
      pendingE8s: 100_000_000n,
      projectedPendingE8s: 100_000_000n,
      undistributedE8s: 0n,
      shareE8s: 0n,
      remainderE8s: 0n,
      nftCount: 2n,
      transferCount: 2n,
      ledgerFeeE8s: 10_000n,
      requiredNetworkFeeE8s: 20_000n,
      feeReserveE8s: 0n,
      feeShortfallE8s: 20_000n,
      callerBalanceE8s: 4_250_000_000n,
      callerFundingTransferFeeE8s: 10_000n,
      callerTotalDebitE8s: 30_000n,
      maxTransfersPerCall: 100n,
    },
  }),
